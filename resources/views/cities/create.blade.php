@extends('layouts.app')
@section('title', 'Add City | Bake N Flake')
...
@section('content')
    <div class="col-md-8">
        <div class="section d-flex flex-column align-items-center">
            ...
            <h2 class="text-hblack font-weight-bold text-capitalize mt-3 sub-heading">Add City</h2>
        </div>
        <div class="card">

            <div class="card-body">
                <form action="{{route('cities.store')}}" method="POST" id="create-city-form" enctype="multipart/form-data">
                    @csrf
