@extends('layouts.app')
@section('title', 'Edit Product | Bake N Flake')
...
@section('content')
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('products.update', $product->id)}}" method="POST" id="create-product-form" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="">
                        <button type="submit" class="col-6 btn btn-warning mt-2">Update</button>
                    </div>
                  </form>
            </div>
          </div>
